...
#Create aliases
alias mytmux='tmux -f ~/.tmuxMySetup.conf attach' #run customized tmux
alias cdgerar='cd C:/Users/gerar' #path to my userfile
...
#set TTYNAME ; not entirely sure of the purpose of this part
function ttyname() { export TTYNAME=$@; }

#set up for the window title
export TTYNAME=$$
function settitle() {
    p=$(pwd);
    let l=${#p}-25
...
#Colors for the bash prompt
inputcolor='[0;37m'
cwdcolor='[0;34m'
gitcolor='[1;31m'


#To my understanding, this line is a function that runs after every command
#it provides the window title, obtains the name of the git branch, and "flushes the
#history
PROMPT_COMMAND='settitle; git_branch; history -a;' 


#PS1 is the variable to control the bash prompt
export PS1='\[\e${cwdcolor}\][$PWD]\[\e${gitcolor}\]${gitbranch}\[\e${inputcolor}\]\[ $ \]'
##################################################################################################################
